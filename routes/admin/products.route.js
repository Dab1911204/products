...
const upload = multer({ storage: storageMulter() }); // cấu hình multer để lưu file tải lên vào thư mục uploads
...
routes.post('/create',upload.single('thumbnail'),productsValidates.createPost ,productsController.createPost);
routes.get('/edit/:id', productsController.edit);
routes.patch('/edit/:id',upload.single('thumbnail'),productsValidates.createPost, productsController.editPatch);
